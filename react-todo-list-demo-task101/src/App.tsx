        ...
        {filteredTodos.length === 0 ? (
          ...
          <li className="empty-state">
            ...
            <p>
              ...
              {filter === 'all' && 'ยังไม่ได้เพิ่มรายการเเรกขแงคุณเลย!'}
              {filter === 'active' && 'ไม่มีรายการที่ต้องทำ'}
              {filter === 'completed' && 'ไม่มีรายการที่เสร็จ'}
            </p>
          </li>
        ) : (
      ...
      {/* เติม conditional rendering ที่นี่ */}
      {
        completedCount > 0 && (
          <div className ='clear-btn' onClick = {clearCompleted}>
            ล้างรายการที่เสร็จเเล้ว({completedCount})
          </div> 
        )
      }
    </div>
